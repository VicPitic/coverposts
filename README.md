# [DashUI Next.js Free Admin Template](https://dashui-free-nextjs-admin-template.vercel.app/)
 Coverposts - Next.js Free admin / dashboard  template created by [Codescandy](https://codescandy.com/) and available on Github
...
## Coverposts Next.js Free / Pro Version

| Free Version        | Coverposts Pro
|---------------------|-------------------------------------------- |
