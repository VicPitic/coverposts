    ...
    const socialMediaShareOptions = [
        {
            ...
            label: 'Facebook',
            icon: 'facebook',
            shareUrl: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://app.coverposts.com")}`,
        },
        {
            platform: 'twitter',
            label: 'Twitter',
            icon: 'twitter',
            shareUrl: `https://twitter.com/intent/tweet?url=${encodeURIComponent("https://app.coverposts.com")}&text=${encodeURIComponent(selectedPost?.text || '')}`,
        },
        {
            platform: 'linkedin',
            label: 'LinkedIn',
            icon: 'linkedin',
            shareUrl: `https://www.linkedin.com/shareArticle?url=${encodeURIComponent("https://app.coverposts.com")}&title=${encodeURIComponent(selectedPost?.text || '')}`,
        },
        {
            platform: 'reddit',
            label: 'Reddit',
            icon: 'reddit',
            shareUrl: `https://www.reddit.com/submit?url=${encodeURIComponent("https://app.coverposts.com")}&title=${encodeURIComponent(selectedPost?.text || '')}`,
        },
        {
            platform: 'instagram',
            label: 'Instagram',
